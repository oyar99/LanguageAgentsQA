...
Evaluate the performance of multiple agent-based architectures designed to solve natural language tasks including QA and MHQA.
...
\begin{enumerate}
    ...
    \item Evaluate the systems using Recall and Recall@k for retrieval performance and Exact Match (EM), ROUGE-1 and ROUGE-2, and an LLM binary judge score for QA across four benchmark datasets: LoCoMo, HotpotQA, MuSiQue, and 2WikiMultiHopQA.
