...
An agent is broadly defined as a system that can perceive its environment, reason about it, and autonomously take actions to achieve specific goals. Traditional agents have relied on symbolic reasoning or domain-specific heuristics, but recent advances in LLMs have enabled a new class of language agents.
