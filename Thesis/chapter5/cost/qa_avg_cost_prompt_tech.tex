...
\begin{figure}[ht]
            ...
            \node[
                ...
                \shortstack{
                    \begin{tabular}{@{}c@{\hskip 0.5em}c@{\hskip 1.5em}c@{\hskip 0.5em}c@{\hskip 1.5em}c@{\hskip 0.5em}c@{\hskip 1.5em}c@{\hskip 0.5em}c@{}}
                        ...
                        \tikz \draw[fill={rgb,255:red,180; green,90; blue,200}, draw=none] (0,0) rectangle (0.4cm,0.2cm); & \scriptsize Cognitive QA Agent \\
                    \end{tabular}
                    \\
    ...
    \end{tikzpicture}
    \caption{Average $token$ usage between ColBERTV2 (k=100), QA Agent, Auto DAG Agent, and Cognitive QA Agent with GPT-4o-mini on QA datasets.}
