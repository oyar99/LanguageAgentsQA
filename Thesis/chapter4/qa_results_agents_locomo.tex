\begin{table}[ht]
    \centering
        ...
        \begin{tabular}{lcccc}
            ...
            GPT-4.1-mini & 20.8 & 43.4 & 22.4 & 40.0 \\
            \midrule
            \multicolumn{5}{c}{\textbf{Auto DAG Agent}} \\
            \midrule
            GPT-4o-mini & 18.4 & 39.1 & 20.0 & 35.0 \\
            GPT-4.1-mini & 19.5 & 41.6 & 21.4 & 39.0 \\
            \midrule
            \multicolumn{5}{c}{\textbf{Long-lived QA Agent}} \\
            \midrule
            GPT-4o-mini & 24.4 & 48.4 & 26.2 & 45.0 \\
            \bottomrule
        \end{tabular}
        
    \caption{QA performance of languages agents on LoCoMo, measured using Exact Match (EM), ROUGE-1 ($R_1$), ROUGE-2 ($R_2$), and an LLM-based score ($L_1$).}
